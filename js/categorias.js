...
export const IC = {
  ...
  lapiz:'<path d="M4 20h4l10.5-10.5a2.8 2.8 0 0 0-4-4L4 16z"/><path d="M13.5 6.5l4 4"/>',
  foto:'<path d="M4 8h3l1.5-2h7L17 8h3a1.6 1.6 0 0 1 1.6 1.6v8A1.6 1.6 0 0 1 20 19.2H4A1.6 1.6 0 0 1 2.4 17.6v-8A1.6 1.6 0 0 1 4 8z"/><circle cx="12" cy="13" r="3.4"/>',
